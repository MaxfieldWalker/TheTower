    ...
    void Update()
    {
        ...
        for (i = 0; i < 2; i++)//x,y,z方向でそれぞれ行う
        {
            ...
            if (i == 0) {
                ...
                for (i = 0; i < 3; i++) ArmScr[i].SphScr.transform.Translate(Ene / dx, 0, 0, Space.World);
            }
            if (i == 1) {
                transform.Translate(0, -Ene / dx, 0, Space.World);
                for (i = 0; i < 3; i++) ArmScr[i].SphScr.transform.Translate(0, Ene / dx, 0, Space.World);
            }
            if (i == 2) {
                transform.Translate(0, 0, -Ene / dx, Space.World);
                for (i = 0; i < 3; i++) ArmScr[i].SphScr.transform.Translate(0, 0, Ene / dx, Space.World);
            }
